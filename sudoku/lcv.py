...
def MRV_MCV_LCV(sudokuboard):
    ...
    while(cont):
        ...
        sudokuboard.set_value(nextrow, nextcol, minapp)
...
print forward_checking(init_board("test2.txt"))
'''
...
TestSolvers("test1.txt")
TestSolvers("test2.txt")
TestSolvers("test3.txt")
'''
